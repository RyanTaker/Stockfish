...
namespace {
  ...
  // Data was extracted from CCRL game database with some simple filtering criteria and some manual
  // influence reduction to try and phase it out slowly.
  const int MoveImportance[] = {
    7605, 7571, 7549, 7522, 7493, 7462, 7425,
    7385, 7350, 7308, 7272, 7230, 7180, 7139, 7094, 7055, 7010, 6959, 6902, 6841, 6778, 6705, 6651,
    6550, 6508, 6435, 6378, 6323, 6253, 6152, 6085, 5995, 5931, 5859, 5794, 5717, 5646, 5544, 5462,
    ...
    2985, 2894, 2828, 2786, 2727, 2676, 2635, 2589, 2538, 2490, 2442, 2394, 2345, 2302, 2243, 2192,
    ...
    878, 865, 852, 828, 801, 787, 770, 753, 744, 731, 722, 706, 700, 683, 676, 671, 664, 652, 641,
    ...
    118, 118, 117, 115, 114, 108, 107, 105, 105, 105, 102, 97, 97, 95, 94, 93, 92, 90, 88, 85, 82,
    82, 81, 81, 81, 80, 79, 77, 75, 73, 72, 70, 68, 65, 63, 61, 61, 59, 59, 59, 58, 56, 55, 54, 54,
    52, 49, 48, 48, 48, 48, 45, 45, 45, 44, 43, 41, 41, 41, 41, 40, 40, 38, 37, 36, 34, 34, 33, 32,
    31, 30};
    
  const int RangeOfImportantMoves = sizeof(MoveImportance)/sizeof(*MoveImportance);

  int move_importance(int ply) { return MoveImportance[std::min(ply, RangeOfImportantMoves)]; }
