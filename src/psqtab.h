...
static const Score PSQT[][SQUARE_NB] = {
  ...
  { // Knight
   S(0, -100), S(0, -80), S(0, -55), S(0, -40), S(0, -40), S(0, -55), S(0, -80), S(0, -100), 
   S(0,  -80), S(0, -55), S(0, -30), S(0, -15), S(0, -15), S(0, -30), S(0, -55), S(0,  -80), 
   S(0,  -55), S(0, -30), S(0,  -5), S(0,   5), S(0,   5), S(0,  -5), S(0, -30), S(0,  -55), 
   S(0,  -40), S(0, -15), S(0,   5), S(0,  15), S(0,  15), S(0,   5), S(0, -15), S(0,  -40), 
   S(0,  -40), S(0, -15), S(0,   5), S(0,  15), S(0,  15), S(0,   5), S(0, -15), S(0,  -40), 
   S(0,  -55), S(0, -30), S(0,  -5), S(0,   5), S(0,   5), S(0,  -5), S(0, -30), S(0,  -55), 
   S(0,  -80), S(0, -55), S(0, -30), S(0, -15), S(0, -15), S(0, -30), S(0, -55), S(0,  -80), 
   S(0, -100), S(0, -80), S(0, -55), S(0, -40), S(0, -40), S(0, -55), S(0, -80), S(0, -100)
  ...
  { // Queen
   S(0, -80), S(0, -50), S(0, -40), S(0, -30), S(0, -30), S(0, -40), S(0, -50), S(0, -80), 
   S(0, -50), S(0, -30), S(0, -15), S(0,  -5), S(0,  -5), S(0, -15), S(0, -30), S(0, -50), 
   S(0, -40), S(0, -15), S(0,  -5), S(0,   5), S(0,   5), S(0,  -5), S(0, -15), S(0, -40), 
   S(0, -30), S(0,  -5), S(0,   5), S(0,  15), S(0,  15), S(0,   5), S(0,  -5), S(0, -30), 
   S(0, -30), S(0,  -5), S(0,   5), S(0,  15), S(0,  15), S(0,   5), S(0,  -5), S(0, -30), 
   S(0, -40), S(0, -15), S(0,  -5), S(0,   5), S(0,   5), S(0,  -5), S(0, -15), S(0, -40), 
   S(0, -50), S(0, -40), S(0, -15), S(0,  -5), S(0,  -5), S(0, -15), S(0, -30), S(0, -50), 
   S(0, -80), S(0, -50), S(0, -40), S(0, -30), S(0, -30), S(0, -40), S(0, -50), S(0, -80)
  },
  { // King
