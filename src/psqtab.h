...
static const Score PSQT[][SQUARE_NB] = {
  ...
  { // Pawn
   ...
   S(-20,-8), S(-6,-8), S( 4,-8), S(10,-8), S(10,-8), S( 4,-8), S(-6,-8), S(-20,-8),
   S(-20,-8), S(-6,-8), S( 9,-8), S(20,-8), S(20,-8), S( 9,-8), S(-6,-8), S(-20,-8),
   S(-20,-8), S(-6,-8), S(17,-8), S(30,-8), S(30,-8), S(17,-8), S(-6,-8), S(-20,-8),
   S(-20,-8), S(-6,-8), S(17,-8), S(15,-8), S(15,-8), S(17,-8), S(-6,-8), S(-20,-8),
   S(-20,-8), S(-6,-8), S( 9,-8), S(10,-8), S(10,-8), S( 9,-8), S(-6,-8), S(-20,-8),
   S(-20,-8), S(-6,-8), S( 4,-8), S(10,-8), S(10,-8), S( 4,-8), S(-6,-8), S(-20,-8),
   S(  0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S(0,  0), S( 0, 0), S( 0, 0), S(  0, 0)
  },
  { // Knight
