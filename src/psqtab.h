...
static const Score PSQT[][SQUARE_NB] = {
  ...
  { // Pawn
   ...
   S(0,0), S(0,0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S(0,0), S(0,0),
   S(0,0), S(0,0), S( 5, 0), S(22, 0), S(22, 0), S( 5, 0), S(0,0), S(0,0),
   S(0,0), S(0,0), S(13, 0), S(44, 0), S(44, 0), S(13, 0), S(0,0), S(0,0),
   S(0,0), S(0,0), S(13, 0), S(22, 0), S(22, 0), S(13, 0), S(0,0), S(0,0),
   S(0,0), S(0,0), S( 5, 0), S( 0, 0), S( 0, 0), S( 5, 0), S(0,0), S(0,0),
   S(0,0), S(0,0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S(0,0), S(0,0),
   S(0,0), S(0,0), S( 0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S(0,0), S(0,0)
  },
  { // Knight
  ...
  { // Queen
   S(0,-80), S(0,-54), S(0,-42), S(0,-30), S(0,-30), S(0,-42), S(0,-54), S(0,-80),
   S(0,-54), S(0,-30), S(0,-18), S(0, -6), S(0, -6), S(0,-18), S(0,-30), S(0,-54),
   S(0,-42), S(0,-18), S(0, -6), S(0,  6), S(0,  6), S(0, -6), S(0,-18), S(0,-42),
   S(0,-30), S(0, -6), S(0,  6), S(0, 18), S(0, 18), S(0,  6), S(0, -6), S(0,-30),
   S(0,-30), S(0, -6), S(0,  6), S(0, 18), S(0, 18), S(0,  6), S(0, -6), S(0,-30),
   S(0,-42), S(0,-18), S(0, -6), S(0,  6), S(0,  6), S(0, -6), S(0,-18), S(0,-42),
   S(0,-54), S(0,-30), S(0,-18), S(0, -6), S(0, -6), S(0,-18), S(0,-30), S(0,-54),
   S(0,-80), S(0,-54), S(0,-42), S(0,-30), S(0,-30), S(0,-42), S(0,-54), S(0,-80)
