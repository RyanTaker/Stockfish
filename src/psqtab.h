...
static const Score PSQT[][SQUARE_NB] = {
  ...
  { // Knight
   ...
   S( -53, -55), S( -25,-30), S(  1, -6), S(  9,  5), S(  9,  5), S(  1, -6), S( -25,-30), S( -53, -55),
   S( -25, -42), S(   1,-17), S( 27,  5), S( 41, 18), S( 41, 18), S( 27,  5), S(   1,-17), S( -25, -42),
   S( -11, -42), S(   9,-17), S( 41,  5), S( 55, 18), S( 55, 18), S( 41,  5), S(   9,-17), S( -11, -42),
   S( -11, -55), S(   9,-30), S( 41, -6), S( 55,  5), S( 55,  5), S( 41, -6), S(   9,-30), S( -11, -55),
   S( -53, -79), S( -25,-55), S(  1,-30), S(  9,-17), S(  9,-17), S(  1,-30), S( -25,-55), S( -53, -79),
