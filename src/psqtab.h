...
static const Score PSQT[][SQUARE_NB] = {
  ...
  { // Pawn
   ...
   S(-20,-8), S(-6,-8), S( 9,-8), S(36,-8), S(36,-8), S( 9,-8), S(-6,-8), S(-20,-8),
   S(-20,-8), S(-6,-8), S(17,-8), S(50,-8), S(50,-8), S(17,-8), S(-6,-8), S(-20,-8),
   S(-20,-8), S(-6,-8), S(17,-8), S(36,-8), S(36,-8), S(17,-8), S(-6,-8), S(-20,-8),
   S(-20,-8), S(-6,-8), S( 9,-8), S(14,-8), S(14,-8), S( 9,-8), S(-6,-8), S(-20,-8),
   S(-20,-8), S(-6,-8), S( 4,-8), S(14,-8), S(14,-8), S( 4,-8), S(-6,-8), S(-20,-8),
   S(  0, 0), S( 0, 0), S( 0, 0), S( 0, 0), S(0,  0), S( 0, 0), S( 0, 0), S(  0, 0)
  },
  { // Knight
   S(-122,-104), S( -65,-79), S(-80,-55), S(-67,-42), S(-67,-42), S(-80,-55), S( -65,-79), S(-122,-104),
   S( -74, -79), S( -67,-55), S(-39,-30), S(-25,-17), S(-25,-17), S(-39,-30), S( -67,-55), S( -74, -79),
   ...
   S(-153,-104), S( -67,-79), S(-39,-55), S(-25,-42), S(-25,-42), S(-39,-55), S( -67,-79), S(-153,-104)
  },
  { // Bishop
   S(-40,-59), S(-30,-42), S(-30,-26), S(-30,-26), S(-30,-26), S(-35,-26), S(-30,-42), S(-40,-59),
   S(-17,-42), S(  0,-26), S(  0,-18), S(  0,-11), S(  0,-11), S(  0,-18), S(  0,-26), S(-17,-42),
   S(-13,-35), S(  0,-18), S(  4,-11), S(  4, -4), S(  4, -4), S(  4,-11), S(  0,-18), S(-13,-35),
   S( -8,-26), S(  0,-11), S(  4, -4), S( 14,  4), S( 14,  4), S(  4, -4), S(  0,-11), S( -8,-26),
   S( -8,-26), S(  0,-11), S(  4, -4), S( 14,  4), S( 14,  4), S(  4, -4), S(  0,-11), S( -8,-26),
   S(-13,-35), S(  0,-18), S(  4,-11), S(  4,  0), S(  4,  0), S(  4,-11), S(  0,-18), S(-13,-35),
   S(-17,-42), S(  0,-26), S(  0,-18), S(  0,-11), S(  0,-11), S(  0,-18), S(  0,-26), S(-17,-42),
   S(-17,-59), S(-17,-42), S(-13,-35), S( -8,-26), S( -8,-26), S(-13,-35), S(-17,-42), S(-17,-59)
  },
  { // Rook
   S(-10, 3), S(-7, 3), S(-2, 3), S(2, 3), S(2, 3), S(-2, 3), S(-7, 3), S(-10, 3),
   S(-10, 3), S(-7, 3), S(-2, 3), S(2, 3), S(2, 3), S(-2, 3), S(-7, 3), S(-10, 3),
   S(-10, 3), S(-7, 3), S(-2, 3), S(2, 3), S(2, 3), S(-2, 3), S(-7, 3), S(-10, 3),
   S(-10, 3), S(-7, 3), S(-2, 3), S(2, 3), S(2, 3), S(-2, 3), S(-7, 3), S(-10, 3),
   S(-10, 3), S(-7, 3), S(-2, 3), S(2, 3), S(2, 3), S(-2, 3), S(-7, 3), S(-10, 3),
  ...
  { // Queen
   S(8,-70), S(8,-54), S(8,-42), S(8,-30), S(8,-30), S(8,-42), S(8,-54), S(8,-70),
   S(8,-54), S(8,-30), S(8,-18), S(8, -6), S(8, -6), S(8,-18), S(8,-30), S(8,-54),
   S(8,-42), S(8,-18), S(8, -6), S(8,  6), S(8,  6), S(8, -6), S(8,-18), S(8,-42),
   S(8,-30), S(8, -6), S(8,  6), S(8, 12), S(8, 12), S(8,  6), S(8, -6), S(8,-30),
   S(8,-30), S(8, -6), S(8,  6), S(8, 12), S(8, 12), S(8,  6), S(8, -6), S(8,-30),
   S(8,-42), S(8,-18), S(8, -6), S(8,  6), S(8,  6), S(8, -6), S(8,-18), S(8,-42),
   S(8,-54), S(8,-30), S(8,-18), S(8, -6), S(8, -6), S(8,-18), S(8,-30), S(8,-54),
   S(8,-70), S(8,-54), S(8,-42), S(8,-30), S(8,-30), S(8,-42), S(8,-54), S(8,-70)
  ...
  { // King
   S(287, 18), S(295, 77), S(262,105), S(232,135), S(232,135), S(262,105), S(295, 77), S(287, 18),
