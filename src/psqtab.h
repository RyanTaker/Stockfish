...
static const Score PSQT[][SQUARE_NB] = {
  ...
  { // Knight
   ...
   S( -25, -42), S(   1,-17), S( 23,  5), S( 35, 18), S( 35, 18), S( 23,  5), S(   1,-17), S( -25, -42),
   S( -11, -42), S(  13,-17), S( 35,  5), S( 35, 18), S( 35, 18), S( 35,  5), S(  13,-17), S( -11, -42),
   S( -11, -55), S(  13,-30), S( 35, -6), S( 35,  5), S( 35,  5), S( 35, -6), S(  13,-30), S( -11, -55),
  ...
  { // King
   S(287, 18), S(300, 77), S(262,105), S(234,135), S(234,135), S(262,105), S(300, 77), S(287, 18),
   S(262, 77), S(287,135), S(238,165), S(206,193), S(206,193), S(238,165), S(287,135), S(262, 77),
   S(214,105), S(238,165), S(190,193), S(142,214), S(142,214), S(190,193), S(238,165), S(214,105),
   S(190,135), S(214,193), S(167,214), S(119,232), S(119,232), S(167,214), S(214,193), S(190,135),
   S(167,135), S(190,193), S(142,214), S( 94,232), S( 94,232), S(142,214), S(190,193), S(167,135),
   S(142,105), S(167,165), S(119,193), S( 69,214), S( 69,214), S(119,193), S(167,165), S(142,105),
   S(125, 77), S(142,135), S( 94,165), S( 53,193), S( 53,193), S( 94,165), S(142,135), S(125, 77),
   S(100, 18), S(125, 77), S( 80,105), S( 50,135), S( 50,135), S( 80,105), S(125, 77), S(100, 18)
  }
};
