...
static const Score PSQT[][SQUARE_NB] = {
  ...
  { // Bishop
   ...
   S(-15,-42), S(  0,-26), S( -4,-18), S(  0,-11), S(  0,-11), S( -4,-18), S(  0,-26), S(-15,-42),
   S(-13,-35), S( -4,-18), S(  8,-11), S(  4, -4), S(  4, -4), S(  8,-11), S( -4,-18), S(-13,-35),
   S( -8,-26), S(  0,-11), S(  4, -4), S( 10,  4), S( 10,  4), S(  4, -4), S(  0,-11), S( -8,-26),
   S( -8,-26), S(  0,-11), S(  4, -4), S( 10,  4), S( 10,  4), S(  4, -4), S(  0,-11), S( -8,-26),
   S(-13,-35), S( -4,-18), S(  8,-11), S(  4, -4), S(  4, -4), S(  8,-11), S( -4,-18), S(-13,-35),
   S(-15,-42), S(  0,-26), S( -4,-18), S(  0,-11), S(  0,-11), S( -4,-18), S(  0,-26), S(-15,-42),
   S(-15,-59), S(-15,-42), S(-13,-35), S( -8,-26), S( -8,-26), S(-13,-35), S(-15,-42), S(-15,-59)
  },
  { // Rook
  ...
  { // Queen
   ...
   S(8,-54), S(8,-30), S(8,-14), S(8, -6), S(8, -6), S(8,-14), S(8,-30), S(8,-54),
   S(8,-42), S(8,-14), S(8, -6), S(8,  6), S(8,  6), S(8, -6), S(8,-14), S(8,-42),
   S(8,-30), S(8, -6), S(8,  6), S(8, 14), S(8, 14), S(8,  6), S(8, -6), S(8,-30),
   S(8,-30), S(8, -6), S(8,  6), S(8, 14), S(8, 14), S(8,  6), S(8, -6), S(8,-30),
   S(8,-42), S(8,-14), S(8, -6), S(8,  6), S(8,  6), S(8, -6), S(8,-14), S(8,-42),
   S(8,-54), S(8,-30), S(8,-14), S(8, -6), S(8, -6), S(8,-14), S(8,-30), S(8,-54),
   S(8,-70), S(8,-54), S(8,-42), S(8,-30), S(8,-30), S(8,-42), S(8,-54), S(8,-70)
