...
namespace {
  ...
  const Score WeightsInternal[] = {
      S(294, 350), S(233, 201), S(221, 273), S(46, 0), S(271, 0), S(307, 0)
  };
    ...
    V(0), V(4),V(17),V(17),V(17),V(17), V(4), V(0) },
  {
    ...
    V(0), V(0), V(0),  V(0), V(0), V(0), V(0), V(0),
    V(0), V(0), V(17), V(17),V(17),V(17),V(0), V(0),
    V(0), V(17),V(22), V(22),V(22),V(22),V(17),V(0),
    V(0), V(22),V(33), V(33),V(33),V(33),V(22),V(0),
    V(0), V( 9),V(12), V(12),V(12),V(12),V(17),V(0) }
  };
