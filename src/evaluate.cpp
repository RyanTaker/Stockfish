...
namespace {
  ...
  const Score WeightsInternal[] = {
      S(294, 344), S(233, 201), S(221, 273), S(46, 0), S(271, 0), S(307, 0)
  };
  ...
  //  A     B     C     D     E     F     G     H
    ...
    V(0), V(7), V(27),V(56),V(56),V(27), V(7), V(0),
    V(0), V(12),V(36),V(65),V(65),V(36), V(12),V(0),
    V(0), V(7), V(27),V(17),V(17),V(27), V(7), V(0) },
  {
