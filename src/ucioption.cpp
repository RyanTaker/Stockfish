...
void init(OptionsMap& o) {
  ...
  o["Standard Pawn Position"]      = Option(230, 0, 600, on_eval);
  o["Passed Pawns (Middle Game)"]  = Option(100, 0, 200, on_eval);
  o["Passed Pawns (Endgame)"]      = Option(100, 0, 200, on_eval);
  o["Space"]                       = Option(100, 0, 200, on_eval);
  o["PSQT: Center Control (MG)"]   = Option(100, 0, 200, on_eval);
  o["PSQT: Default (MG)"]          = Option(100, 0, 200, on_eval);
  o["PSQT: Default (EG)"]          = Option(100, 0, 200, on_eval);
  o["PSQT: King Safety (MG)"]      = Option( 70, 0, 200, on_eval);
  o["PSQT: King in Center (EG)"]   = Option(100, 0, 200, on_eval);
  o["Aggressiveness"]              = Option(115, 0, 200, on_eval);
  o["Cowardice"]                   = Option(120, 0, 200, on_eval);
